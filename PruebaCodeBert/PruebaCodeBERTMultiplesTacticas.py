...
if __name__ == "__main__":
    ...
    for ruta in tqdm(archivos, desc="Analizando archivos"):
        try:
            ...
            # Detectar múltiples tácticas con probabilidad mayor a un umbral
            threshold = 0.85  # puedes ajustarlo según tus necesidades
            pred_labels = torch.where(probs[0] > threshold)[0]

            if len(pred_labels) == 0:
                continue  # no se detectó ninguna táctica con confianza suficiente
